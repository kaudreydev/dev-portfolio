...
import { UiViewportProvider, useViewport } from "@uireact/tools";
...
export default function SkillCards({ skills }: { skills: Skill[] }) {
  ...
  useEffect(() => {
    if (isSmall) setIconSize(iconSizeA);
    else setIconSize(iconSizeB);
  }, [isSmall]);

  return (
    <UiViewportProvider data={tailwindBreakpoints}>
              ...
              <CardHeader>
                ...
                <CardDescription>
                  <div className="grid grid-flow-col gap-2 leading-2.5">
                    ...
                    <div>
                      <div className="skill-years md:skill-years-md text-center">
                        {skill.years}
                      </div>
                      <br />
